        ...
        <div class="row g-6 settings-section">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('professeur.dashboard') }}" class="btn app-btn-secondary">
            ...
            <div class="col-12">
                <div class="app-card app-card-settings shadow-sm p-4">
                    <div class="app-card-body">
                        ...
                        <form id="main_form" class="settings-form" method="POST" action="{{ route('professeur.store-besoin') }}" style="display:none;">
                            @csrf
                            @method('POST')
