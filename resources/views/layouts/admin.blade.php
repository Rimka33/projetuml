...
<html lang="fr">
<head>
    <title>@yield('title', 'Administration - UML')</title>
    <meta charset="utf-8">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                <div class="app-branding">
                    <a class="app-logo" href="{{ route('dashboard') }}">
                        <img class="logo-icon me-2" src="{{ asset('assets/images/logoESP.png') }}" alt="logo ESP">
                        <span class="logo-text">Administration UML</span>
                    </a>
                </div>
